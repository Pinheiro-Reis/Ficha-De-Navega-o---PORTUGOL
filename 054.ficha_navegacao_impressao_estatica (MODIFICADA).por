programa {
  ...
  funcao imprimirFichaNavegacao(inteiro velocidade, cadeia indicativos[], cadeia horaDecolagem[], cadeia horaPouso[], inteiro consumoHora, inteiro gmt[], inteiro tempoTotal, inteiro distanciaTotal, inteiro consumoTotal, inteiro qtPts, cadeia pontos[], inteiro rumos[], inteiro distancias[], inteiro tempos[], cadeia etos[])
  {
  ...
  funcao inicio()
  {
    inteiro qtPts=0
  	...
  	enquanto (end)
  	{
	  	...
	  	inteiro gmt[2], rumos[qtPts], distancias[qtPts], tempos[qtPts], loop = 1, consumoHora, distanciaTotal, consumoTotal, velocidade
	    ...
	    enquanto(loop == 1)
		{
		  ...
		  escolha(MenuPrincipal())
		  {
			  ...
			  //{
				...
				horaPouso[1] = mudarHorario(gmt[0], tempoTotal)
