  ...
  funcao imprimirFichaNavegacao(real qtPts, cadeia pontos[], real rumos[], real distancias[], real tempos[], real etos[])
  {
    se(navegacaoCalculada)
	{
      ...
      { 
        //escreva("\n\n",distancias,"\n\n")escreva(tempos)
		escreva("|")
        cadeia impressao = formataMensagem(pontos[i],28) + formataNumero(rumos[i], 3) + formataNumero(tempos[i], 3) + formataNumero(etos[i],3) + "|\n"
        escreva(impressao)
