programa {
  ...
  funcao imprimirFichaNavegacao(real qtPts, cadeia pontos[], inteiro rumos[], real distancias[], real tempos[], cadeia etos[])
  {
    se(navegacaoCalculada)
	{
      ...
      { 
        //escreva("\n\n",distancias,"\n\n")escreva(tempos)
        cadeia impressao = formataMensagem(pontos[i],28) + formataNumero(rumos[i], 10) + formataNumero(distancias[i], 15) + formataNumero(tempos[i], 11) + formataMensagem(etos[i],12) + "|\n"
        escreva(impressao)
